# Europaplus SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EuropaplusSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EuropaplusSDK(...) and EuropaplusSDK.test(...) become
#      EuropaplusSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "europaplus_sdk"
_SDK_CLASS = "EuropaplusSDK"
