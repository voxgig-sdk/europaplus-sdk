...
class TestScheduleEntity:
    ...
    def test_should_stream(self):
        ...
        base = EuropaplusSDK.test(seed, None)
    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set EUROPAPLUS_TEST_SCHEDULE_ENTID JSON to run live")
        client = setup["client"]
...
def _schedule_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("EUROPAPLUS_TEST_SCHEDULE_ENTID"))
    ...
    if env.get("EUROPAPLUS_TEST_LIVE") == "TRUE":
        ...
        client = EuropaplusSDK(helpers.to_map(merged_opts))

    _live = env.get("EUROPAPLUS_TEST_LIVE") == "TRUE"
    return {
        "client": client,
        "data": entity_data,
        "idmap": idmap_resolved,
        "env": env,
        "explain": env.get("EUROPAPLUS_TEST_EXPLAIN") == "TRUE",
        "live": _live,
