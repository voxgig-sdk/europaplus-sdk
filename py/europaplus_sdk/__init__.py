...
from europaplus_sdk.utility import register

# Load features
from europaplus_sdk.feature.base_feature import EuropaplusBaseFeature
from europaplus_sdk.features import _has_feature, _make_feature
...
class EuropaplusSDK:
    ...
    def get_utility(self):
        return EuropaplusUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("EuropaplusSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Schedule(self, data=None) -> "ScheduleEntity":
        ...
        from europaplus_sdk.entity.schedule_entity import ScheduleEntity
