...
class EuropaplusCacheFeature extends EuropaplusBaseFeature
{
    ...
    private function _through(EuropaplusContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
