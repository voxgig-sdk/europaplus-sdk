...
// Europaplus SDK telemetry feature
...
class EuropaplusTelemetryFeature extends EuropaplusBaseFeature
{
    ...
    private function _close(EuropaplusContext $ctx, bool $ok): void
    {
