...
// Europaplus SDK streaming feature
...
class EuropaplusStreamingFeature extends EuropaplusBaseFeature
{
    ...
    private function _iterate(EuropaplusResult $result): \Generator
    {
    ...
    private function _streamable(EuropaplusContext $ctx): bool
    {
