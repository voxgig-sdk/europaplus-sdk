...
// Europaplus SDK timeout feature
...
class EuropaplusTimeoutFeature extends EuropaplusBaseFeature
{
    ...
    private function _with_timeout(EuropaplusContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EuropaplusContext $_ctx, float $ms): void
    {
        $client = $this->client;
