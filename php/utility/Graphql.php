...
// Europaplus SDK utility: graphql
//
...
class EuropaplusGraphql
{
    ...
    // equivalent.
    public static function body(EuropaplusContext $ctx): mixed
    {
    ...
    public static function errors(EuropaplusContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
