...
// Europaplus SDK utility: fetcher

class EuropaplusFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EuropaplusSDK/1.0)';
    ...
    public static function call(EuropaplusContext $ctx, string $fullurl, array $fetchdef): array
    {
