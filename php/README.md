...
print_r(array_map(fn($item) => $item->data_get(), $schedule));
```
...
```php
require_once 'europaplus_sdk.php';
$client = new EuropaplusSDK($options);
```
...
```
php/
├── europaplus_sdk.php          -- Main SDK class
...
The main class (`europaplus_sdk.php`) exports the SDK class
