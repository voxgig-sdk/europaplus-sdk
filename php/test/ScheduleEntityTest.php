...
class ScheduleEntityTest extends TestCase
{
    ...
    {
        $testsdk = EuropaplusSDK::test(null, null);
    ...
    public function test_stream(): void
    {
        ...
        $base = EuropaplusSDK::test($seed, null);
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set EUROPAPLUS_TEST_SCHEDULE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function schedule_basic_setup($extra)
{
    ...
    $client = EuropaplusSDK::test($options, $extra);
    ...
    $entid_env_raw = getenv("EUROPAPLUS_TEST_SCHEDULE_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["EUROPAPLUS_TEST_SCHEDULE_ENTID"]);
    ...
    if ($env["EUROPAPLUS_TEST_LIVE"] === "TRUE") {
        ...
        $client = new EuropaplusSDK(Helpers::to_map($merged_opts));
    }
    ...
    return [
        ...
        "env" => $env,
        "explain" => $env["EUROPAPLUS_TEST_EXPLAIN"] === "TRUE",
        "live" => $live,
