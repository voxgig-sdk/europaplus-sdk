...
class EuropaplusTestRunner
{
    ...
    {
        $live = self::getenv('EUROPAPLUS_TEST_LIVE');
        $override = self::getenv('EUROPAPLUS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('EUROPAPLUS_TEST_EXPLAIN');
...
class_alias('EuropaplusTestRunner', 'Runner');
class_alias('EuropaplusHelpers', 'Helpers');
