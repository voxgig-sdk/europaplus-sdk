...
// Europaplus SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EuropaplusSDK::test)
...
{
    private const SDK_CLASS = 'EuropaplusSDK';
    ...
    private const SDK_BASE = 'europaplus_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../europaplus_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
