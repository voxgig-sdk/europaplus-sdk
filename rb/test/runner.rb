...
module EuropaplusTestRunner
  ...
  def self.env_override(m)
    live = getenv("EUROPAPLUS_TEST_LIVE")
    override = getenv("EUROPAPLUS_TEST_OVERRIDE")
    ...
    explain = getenv("EUROPAPLUS_TEST_EXPLAIN")
    m["EUROPAPLUS_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = EuropaplusTestRunner
Helpers = EuropaplusHelpers
Vs = VoxgigStruct
