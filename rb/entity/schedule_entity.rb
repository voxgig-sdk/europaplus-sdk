# Europaplus SDK Schedule entity
...
class ScheduleEntity
  ...
  def data_set(args)
    if args
      @_data = EuropaplusHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  def match_set(args)
    if args
      @_match = EuropaplusHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  # @return [Array<Schedule>, Array] the matching Schedule items; raises EuropaplusError on failure
