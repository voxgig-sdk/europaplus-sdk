...
type Args struct {
	Entity string         `json:"entity" jsonschema:"schedule"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.EuropaplusSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "europaplus_list",
		Description: "List records from Europaplus. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "europaplus_load",
		Description: "Load a single record from Europaplus. " +
...
func runOp(client *sdk.EuropaplusSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.EuropaplusSDK, name string) (sdk.EuropaplusEntity, error) {
