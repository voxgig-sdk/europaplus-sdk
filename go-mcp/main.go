// Command Europaplus-mcp is an MCP server exposing the Europaplus
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Europaplus_list  — list records of an entity
//	Europaplus_load  — load a single record of an entity
//
