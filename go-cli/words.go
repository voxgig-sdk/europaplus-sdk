...
func registerSDKWords(r *eng.Registry, client *sdk.EuropaplusSDK) {
...
func runOp(client *sdk.EuropaplusSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
