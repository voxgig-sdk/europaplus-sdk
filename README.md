...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/europaplus` | `npm install @voxgig-sdk/europaplus` |
| Python | `voxgig-sdk-europaplus` | `pip install voxgig-sdk-europaplus` |
| PHP | `voxgig-sdk/europaplus` | `composer require voxgig-sdk/europaplus` |
| Golang | `github.com/voxgig-sdk/europaplus-sdk/go` | `go get github.com/voxgig-sdk/europaplus-sdk/go` |
| Ruby | `voxgig-sdk-europaplus` | `gem install voxgig-sdk-europaplus` |
| Lua | `voxgig-sdk-europaplus` | `luarocks install voxgig-sdk-europaplus` |
