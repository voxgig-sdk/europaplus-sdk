...
Results: Successful response containing schedule data.
...
| --- | --- | --- | --- |
| Schedule | `list` | `GET /schedule` | See reference |

## Connect to the API

- Europaplus Radio Service: `https://www.europaplus.ru`
...
- `europaplus_list`: List records for an entity. Supported entities: `schedule`.
- `europaplus_load`: Load one record for an entity. No active entity supports this operation.
