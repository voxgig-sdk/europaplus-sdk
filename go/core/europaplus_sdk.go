...
func (sdk *EuropaplusSDK) OptionsMap() map[string]any {
...
func (sdk *EuropaplusSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *EuropaplusSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *EuropaplusSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *EuropaplusSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *EuropaplusSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *EuropaplusSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("EuropaplusSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *EuropaplusSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *EuropaplusSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("EuropaplusSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
