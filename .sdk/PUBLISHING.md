...
|---|---|---|
| `ts/` | @voxgig-sdk/europaplus-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/europaplus-sdk \
      --repository voxgig-sdk/europaplus-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/europaplus-sdk` shows it, and
`npm trust revoke @voxgig-sdk/europaplus-sdk --id=<id>` removes it.
