...
// Europaplus SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class EuropaplusTransformResponse
{
    public static function call(EuropaplusContext $ctx): mixed
    {
        ...
        $transform = EuropaplusHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
