...
// Europaplus SDK ratelimit feature
...
class EuropaplusRatelimitFeature extends EuropaplusBaseFeature
{
    ...
    private function _acquire(EuropaplusContext $ctx): void
    {
    ...
    private function _track(EuropaplusContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
