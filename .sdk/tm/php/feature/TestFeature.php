...
// Europaplus SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class EuropaplusTestFeature extends EuropaplusBaseFeature
{
    ...
    public function init(EuropaplusContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (EuropaplusContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = EuropaplusParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (EuropaplusContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(EuropaplusContext $ctx, $op, $args): array
    {
