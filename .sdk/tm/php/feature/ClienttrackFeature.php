...
// Europaplus SDK clienttrack feature
...
class EuropaplusClienttrackFeature extends EuropaplusBaseFeature
{
    ...
    public function PostConstruct(EuropaplusContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Europaplus-SDK';
