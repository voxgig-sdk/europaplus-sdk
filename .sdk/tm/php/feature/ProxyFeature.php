...
class EuropaplusProxyFeature extends EuropaplusBaseFeature
{
    ...
    public function init(EuropaplusContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EuropaplusContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
