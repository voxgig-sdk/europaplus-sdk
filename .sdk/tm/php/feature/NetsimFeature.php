...
class EuropaplusNetsimFeature extends EuropaplusBaseFeature
{
    ...
    private function _simulate(EuropaplusContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(EuropaplusContext $ctx, array $applied): void
    {
        $client = $this->client;
