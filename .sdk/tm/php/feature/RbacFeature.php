...
class EuropaplusRbacFeature extends EuropaplusBaseFeature
{
    ...
    private function _required(EuropaplusContext $ctx): ?string
    {
    ...
    private function _reject(EuropaplusContext $ctx, string $required): void
    {
    ...
    private function _track(EuropaplusContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
