...
from projectname_sdk.core.control import EuropaplusControl
...
class EuropaplusContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, EuropaplusSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, EuropaplusResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, EuropaplusResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return EuropaplusError(code, msg, self)
