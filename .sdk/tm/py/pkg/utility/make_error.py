# Europaplus SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, EuropaplusError):
        errmsg = err.msg
    ...
    msg = "EuropaplusSDK: " + opname + ": " + errmsg
    ...
    sdk_err = EuropaplusError("", msg, ctx)
