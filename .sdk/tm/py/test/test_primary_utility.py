...
from projectname_sdk import EuropaplusSDK
from projectname_sdk.core.spec import EuropaplusSpec
from projectname_sdk.core.result import EuropaplusResult
from projectname_sdk.core.response import EuropaplusResponse
from projectname_sdk.core.operation import EuropaplusOperation
from projectname_sdk.core.error import EuropaplusError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import EuropaplusBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return EuropaplusError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = EuropaplusSDK.test(None, None)
        ...
        class TestInitFeature(EuropaplusBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(EuropaplusBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = EuropaplusSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = EuropaplusSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = EuropaplusSDK.test(None, setup_opts)
