...
function envOverride(m) {
    if ('TRUE' === process.env.EUROPAPLUS_TEST_LIVE ||
        'TRUE' === process.env.EUROPAPLUS_TEST_OVERRIDE) {
    ...
    m.EUROPAPLUS_TEST_EXPLAIN = process.env.EUROPAPLUS_TEST_EXPLAIN || m.EUROPAPLUS_TEST_EXPLAIN;
    return m;
}
