...
(0, node_test_1.describe)('ScheduleDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('EUROPAPLUS_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.EuropaplusSDK({
...
function liveScenariosActive() { return false && process.env.EUROPAPLUS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.EuropaplusSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['EUROPAPLUS_TEST_SCHEDULE_ENTID'];
    ...
    const client = new __1.EuropaplusSDK({
        base: 'http://localhost:8080',
