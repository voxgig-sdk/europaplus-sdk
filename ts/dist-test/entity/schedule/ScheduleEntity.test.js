...
(0, node_test_1.describe)('ScheduleEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.EuropaplusSDK.test();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set EUROPAPLUS_TEST_SCHEDULE_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    let client = __1.EuropaplusSDK.test(options, extra);
    ...
    const idmapEnvVal = process.env['EUROPAPLUS_TEST_SCHEDULE_ENTID'];
    ...
    if (live) {
        client = new __1.EuropaplusSDK(merge([
