# Europaplus TypeScript SDK



The TypeScript SDK for the Europaplus API — a type-safe, entity-oriented client with full async/await support.
...
| `tester(testopts?, sdkopts?)` | `EuropaplusSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `EuropaplusSDK.test(testopts?, sdkopts?)` | `EuropaplusSDK` | Create a test-mode client. |
...
| `client` | `client(): EuropaplusSDK` | Return the parent SDK client. |
...
europaplus/
├── src/
│   ├── EuropaplusSDK.ts        # Main SDK class
